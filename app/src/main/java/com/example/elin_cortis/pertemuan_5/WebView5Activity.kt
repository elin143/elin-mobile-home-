...
import com.example.elin_cortis.databinding.ActivityWebView5Binding

class WebView5Activity : AppCompatActivity() {
    private lateinit var binding: ActivityWebView5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWebView5Binding.inflate(layoutInflater)
